 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | LAlt |      |      |  ESC | LGui |                                       | RGui | RAlt |   [  |   ]  | ~L2  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Left |  Up  |       | Down | Right|
 *                                 ,------|------|------|       |------+------+------.
 *                                 |      |      | Home |       | PgUp |      |      |
 *                                 | Space|Backsp|------|       |------|LShif+| Enter|
 *                                 | /Ctrl|ace   | End  |       | PgDn |Enter |      |
 *                                 `--------------------'       `--------------------'
 */
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LALT,  KC_NO,  KC_NO,  KC_ESC,  KC_LGUI,
                                                     KC_LEFT,  KC_UP,
                                                               KC_HOME,
                                     CTL_T(KC_SPC),  KC_BSPC,  KC_END,
                                                                          ...
                                                                          // right hand
                                                                           ...
                                                                           MEH_T(KC_NO),  KC_N,   KC_M,  KC_COMM,   KC_DOT,  KC_SLSH,    KC_GRV,
                                                                                               KC_RGUI,  KC_RALT,  KC_LBRC,  KC_RBRC,  TG(MDIA),
                                                                        KC_DOWN,       KC_RGHT,
                                                                        KC_PGUP,
                                                                        KC_PGDN,  LSFT(KC_ENT),  KC_ENT
    ),
