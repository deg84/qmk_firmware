...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT( \
    ...
    KC_LSFT, KC_Z, KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSST, \
                   KC_LGUI, KC_LALT, KC_MHEN, KC_SCTL, KC_BSPC, KC_BSPC, KC_ETMT, KC_HENK, KC_TGGM, KC_ESC  \
  ),
   ...
   * |      |      |      |      |      |      |      |      |      |      |      |      |      |      |
   * `-------------+------+------+------+------+------+------+------+------+------+------+------+------'
   *               |  GUI |  Alt |  EN  |Space/| DELT | Back |Enter/|  JA  |      |      |
   *               |      |      |      |RCtrl |      | Space|~META |      |      |      |
   *               `---------------------------------------------------------------------'
   */
  [_META] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
                      _______, _______, _______, _______, KC_DELT, _______, _______, _______, _______, _______  \
  ),
  ...
  [_GAME] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
                      _______, _______, KC_SPC , _______, KC_BSPC, _______, _______, _______, _______, _______  \
  ),
